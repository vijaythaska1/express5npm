...
export default function DashboardPage() {
  ...
  return (
    <div className="min-h-screen bg-zinc-950 text-zinc-100 p-8 flex flex-col gap-6">
      ...
      <div className="bg-zinc-900/60 backdrop-blur-xl border border-zinc-800 rounded-2xl overflow-hidden shadow-xl flex-1 flex flex-col">
        <div className="p-5 border-b border-zinc-800/80 flex flex-col md:flex-row gap-4 items-center justify-between">
          <div className="relative w-full md:w-80">
            ...
            <input
              ...
              className="w-full pl-9 pr-4 py-2.5 bg-zinc-800/50 border border-zinc-700/60 rounded-xl text-zinc-200 placeholder-zinc-500 text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500/50 focus:border-indigo-500 transition-all"
            />
            {search && (
              <button
                onClick={() => setSearch("")}
          ...
          <div className="text-sm text-zinc-400 self-end md:self-auto">
        ...
        <div className="flex-1 overflow-x-auto min-h-[300px]">
          {isLoading ? (
            ...
            <table className="w-full text-left border-collapse">
              <thead>
                <tr className="border-b border-zinc-800 text-zinc-400 text-xs font-semibold uppercase bg-zinc-900/40 select-none">
      ...
      {isCreateOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center px-4">
          ...
          <div className="bg-zinc-900 border border-zinc-800 rounded-2xl w-full max-w-md p-6 relative z-10 shadow-2xl animate-modal-enter">
            <button
              ...
              <div className="bg-zinc-800/40 p-4 rounded-xl border border-zinc-800 flex flex-col gap-3">
                ...
                <div>
                  ...
                  <div className="mt-1">
                    ...
                    >
                      <span className={`w-1.5 h-1.5 rounded-full ${selectedUser.isActive ? "bg-emerald-400" : "bg-zinc-500"}`} />
